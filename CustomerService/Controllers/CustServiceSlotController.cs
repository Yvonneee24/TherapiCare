...
namespace TherapiCareTest.Areas.CustomerService.Controllers
{
    ...
    public class CustServiceSlotController : Controller
    {
        private readonly ApplicationDbContext _context;

        public CustServiceSlotController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            return RedirectToAction(nameof(Index), new { sessionId = slot.SessionId });
        }
