...
namespace TherapiCareTest.Models
{
    public class Report
    {
        ...
        public string staffId { get; set; } // Therapist
        ...
        [DisplayName("Maximum Assistance")]
        ...
        [DisplayName("Prepare Simple Food")]
        ...
        [DisplayName("Eye Contact with Person")]
        public int eyeContactPerson { get; set; }

        [DisplayName("Eye Contact with Object")]
